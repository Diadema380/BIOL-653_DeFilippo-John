---
title: "For-loop_class-exercises"
...
```{r}
# 3a) Print these values as part of a string that looks something like 'n = 16'. Try to describe in words how I creating the vector of numbers that you are going to use.
...
## Sorry, no clue how to do this with dplyr
